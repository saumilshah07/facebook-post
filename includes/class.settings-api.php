 ...
 * setting api class
 */
if ( !class_exists( 'FBPS_Settings_API' ) ):
class FBPS_Settings_API {
    ...
    function show_import() {
        ...
        <div class="metabox-holder">
            <div class="postbox">
                <h3 class="fbps-title"><?php _e( 'Import', 'facebook-posts' ); ?></h3>
                        <form action="<?php echo admin_url('options-general.php?page=fbps'); ?>" method="post">
                            <input type="hidden" name="fbps-import-config" value="1" />
                            <div style="padding-left: 10px">
                                <?php submit_button( __('Import', 'facebook-posts') ); ?>
                            </div>
                        </form>
            </div>
        </div>
